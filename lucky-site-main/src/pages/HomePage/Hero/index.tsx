...
const Hero: React.FC = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="mt-20 flex items-center justify-center p-[5px_12px] border-solid border-2 border-purple-500 rounded-3xl bg-purple-400 cursor-pointer">
      ...
      <div className="text-lg ml-2 text-gray-500 mt-8">
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="z-2 text-lg ml-6 mt-8 hover:bg-purple-500/40 hover:rounded-xl hover:p-[5px_12px] hover:scale-105 transition-all duration-300 text-white cursor-pointer">
          探索工具
        </div>
      </div>
    </div>
