    ...
    <div>
      ...
      <div className="relative space-y-4 z-10">
        {questions.map((question) => (
          <div
            key={question.id}
            className="flex justify-between items-center p-4 bg-gray-900/50 border border-gray-800 rounded-lg hover:bg-gray-800/50 transition-all duration-200 cursor-pointer hover:border-purple-500/50 group"
          >
            {/* left */}
